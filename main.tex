...
\Abstract{%
  ...
  count pages, tables, and references. The command `noindent' prevents
  indention.  Unfortunately, the author of this template hasn't figured out a
  way to count tables and figure reliably. You will have to insert the counts
  for those manually.
}
